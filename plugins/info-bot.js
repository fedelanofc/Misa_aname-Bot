...
if (/^a/i.test(m.text)) {
conn.reply(m.chat, `*Arroz con pollos*`, m, rcanal, )
}


if (/^wi/i.test(m.text)) {
conn.reply(m.chat, `*ya ya mijo *`, m, rcanal, )
}
...
No discriminación: No permitimos comentarios racistas o xenófobos.

No contenido 18+: Prohibido enviar imágenes, videos o emojis con contenido adulto.

Respeto: No insultar a los demás miembros.

No spam de enlaces: Solo los administradores pueden compartir enlaces de otros grupos.

Si rompes las reglas, serás eliminado.

🔄 Advertencias:

Tienes dos oportunidades. Si rompes las reglas dos veces, serás expulsado.
...
Canal: Sigue el canal

🎃 ¡Gracias por leer las reglas! 🎃
...
if (/^misa$/i.test(m.text)) {
conn.reply(m.chat, `*Hola Eres Fan De* *misaBot o light yagami*

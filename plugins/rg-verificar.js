...
const canales = 'https://whatsapp.com/channel/0029Vaqe1Iv65yDAKBYr6z0A'; // Reemplaza con la URL correcta
  ...
  conn.sendMessage(m.chat, {
    ...
    contextInfo: {
      externalAdReply: {
        title: '⊱『✅𝆺𝅥 𝗥𝗘𝗚𝗜𝗦𝗧𝗥𝗔𝗗𝗢(𝗔) 𝆹𝅥✅』⊰',
        body: wm, 
        thumbnailUrl: 'https://i.postimg.cc/sx4g8qr1/IMG-20250112-WA0028.jpg', 
        sourceUrl: canales,
        mediaType: 1,

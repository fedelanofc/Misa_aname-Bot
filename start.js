...
global.authFile = `misaSession`
global.authFileJB = `misaJadiBot`
...
mobile: MethodMobile, 
browser: opcion == '1' ? ['misaamane-Bot', 'Edge', '2.0.0'] : methodCodeQR ? ['misaamane-Bot', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
...
const subBotDirectory = './misaJadiBot';
if (!existsSync(subBotDirectory)) {
console.log('🚩 Misa-amane-Bot-MD no tiene Sub-Bots vinculados.');
return;
}
...
const mainBotAuthFile = 'misaSession';
try {
const mainBot = await connectionUpdate(mainBotAuthFile);
global.conns.push(mainBot);
console.log(chalk.bold.greenBright(`🚩 Misaamane conectado correctamente.`))

await connectSubBots();
} catch (error) {
console.error(chalk.bold.cyanBright(`🍭 Error al iniciar 𝙈𝙄𝙎𝘼-𝘼𝙈𝘼𝙉𝙀-𝘽𝙊𝙏-𝙈𝘿: `, error))
}
})();*/
